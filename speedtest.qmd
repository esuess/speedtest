...
Conduct three internet speed tests, collect the results in a pandas DataFrame, and generate a histogram of the download times.

Run the code in the next cell to install the necessary packages and run the speed tests.
...
Now run the code in the next cell to perform the speed tests and generate the histogram.
